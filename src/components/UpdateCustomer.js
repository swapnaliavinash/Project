...
export default class UpdateCustomer extends Component {
    ...
    componentDidMount(){
        User_RequestService.getCustomerById(this.state.id).then((res) => {
            ...
            this.state({address: customer.address, email: customer.email,
                 items: customer.items,password: customer.password,
                  pickup_date: customer.pickup_date, request_no: customer.request_no,
                   reward: customer.reward,
                 status: customer.status, username: customer.username})
        })
                ...
                <div className = "container">
                    <div className = "row">
                           <div className = "card col-md-6 offset-md-3  offset-md-3">
                               <h3 className="text-center">Update Customer Reuest</h3>
                                   ...
                                   <form>
                                         ...
                                         <div className = "form-group">
                                              ...
                                              <br></br>
                                               ...
                                               <button className = "btn btn-success" onClick={this.updateRequest}>Update</button>
